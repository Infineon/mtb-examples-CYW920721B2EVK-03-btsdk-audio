...
typedef enum
{
    APP_AUDIO_PLAYBACK_EVENT_STOPPED,
} app_audio_playback_event_t;
...
} app_audio_playback_event_stopped_t;

typedef union
{
    app_audio_playback_event_stopped_t stopped;
} app_audio_playback_event_data_t;

typedef void (app_audio_playback_callback_t)(app_audio_playback_event_t event,
