 ...
 ****************************************************************************/
const wiced_bt_cfg_settings_t hci_ag_cfg_settings =
{
    .device_name                         = (uint8_t *)WICED_DEVICE_NAME,                               /**< Local device name (NULL terminated) */
    .device_class                        = {0x40, 0x02, 0x10},                                         /**< Local device class */
 ...
 *****************************************************************************/
const wiced_bt_cfg_buf_pool_t hci_ag_cfg_buf_pools[] =
{
/*  { buf_size, buf_count } */
...
const wiced_bt_audio_config_buffer_t hci_ag_audio_buf_config = {
    .role                       =   WICED_HF_ROLE,
